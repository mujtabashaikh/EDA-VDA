...
print("*****range ******")
print(df.iloc[:,1:5].min()-df.iloc[:,1:5].max())
...
# Problem: Check if the population mean PetalWidth more than 1.5
...
Categorical 	       4 (Iris-setosa, setosa ,Iris-versicolor, Iris-virginica)
    ...
    ***Conclusion:***
      ...
      Where our population mean of SepalLength mu =  6.25.
      In other hand we done testing on population mean of PetalWidth is <= 1.5
